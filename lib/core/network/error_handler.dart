...
class ResponseCode{
  ...
  static const int UNAUTHORISED = 400;
...
class ResponseMessage{
  ...
  static const String FORBIDDEN = "Access forbidden, you do not have permission";
  static const String UNAUTHORISED = "Unauthorized access, please log in";
  ...
  // local status code
  static const String CONNECT_TIMEOUT = "Connection timed out";
  ...
  static const String DEFAULT = "Error occurred, Please try again later";
}
